...
from Shinobu.utils.database import add_gban_user, remove_gban_user
...
async def useradd(client, message: Message, _):
    if not message.reply_to_message:
        ...
        return await message.reply_text(_["block_2"].format(user.mention))
...
async def userdel(client, message: Message, _):
    if not message.reply_to_message:
        ...
        return await message.reply_text(_["block_4"])
