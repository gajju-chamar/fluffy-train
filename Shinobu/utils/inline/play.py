...
# Stream markup without timer bar
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"ShinobuPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_1(_, videoid, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="▶️ Resume", callback_data=f"ADMIN Resume|{chat_id}"
            ),
        ],
        [
            InlineKeyboardButton(
...
def panel_markup_2(_, videoid, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="🔊 Unmute", callback_data=f"ADMIN Unmute|{chat_id}"
            ),
        ],
        [
            InlineKeyboardButton(
