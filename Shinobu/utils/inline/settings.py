...
def cleanmode_settings_markup(
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_14"] if status else _["ST_B_15"],
        ...
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_14"] if dels else _["ST_B_15"],
...
def auth_users_markup(_, status: Union[bool, str] = None):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_16"] if status else _["ST_B_17"],
                callback_data="AUTH",
            ),
        ],
        [
...
def playmode_users_markup(
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_20"] if Direct else _["ST_B_21"],
        ...
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_16"] if Group else _["ST_B_17"],
        ...
        [
            ...
            InlineKeyboardButton(
                text=_["ST_B_16"] if Playtype else _["ST_B_17"],
